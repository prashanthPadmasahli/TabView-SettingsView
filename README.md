Tabview app with one of the tab is settings. Settings screen is designed with array of models and data is populated in setting detail screen with environment object
